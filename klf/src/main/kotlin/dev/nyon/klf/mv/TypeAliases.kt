...
internal typealias Bindings = /*? if forge {*/  /*net.minecraftforge.fml.Bindings  *//*?} else if lp: <=2.0 {*/ /*net.neoforged.fml.Bindings *//*?} else {*/ net.neoforged.neoforge.internal.NeoForgeBindings /*?}*/
