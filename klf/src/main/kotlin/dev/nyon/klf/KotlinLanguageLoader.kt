...
class KotlinLanguageLoader : IModLanguageLoader {
    private fun verifyCompatibility(info: IModInfo) {
        MinecraftVersionCompatibility.findIncompatibility()?.let { throw modLoadingException(it, info) }
    }
